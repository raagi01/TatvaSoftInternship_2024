...
namespace BackEnd.DAL.JWTService
{
    public class JwtService
    {
        ...
        {
            _secretKey = configuration.GetValue<string>("JwtConfig:Key") ?? throw new ArgumentNullException(nameof(_secretKey), "JWT Secret Key cannot be null");
